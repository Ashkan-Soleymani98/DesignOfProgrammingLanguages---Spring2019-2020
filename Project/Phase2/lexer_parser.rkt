...
(define-empty-tokens b (eof plus minus mult div seteq eq neq gt lt semicolon comma lbrack rbrack lpar rpar ret whilet dot ewhile ift thent elset eif funct lcurly rcurly))
...
(define simple-parser
           ...
           [FUNCTION ((funct lpar VARS rpar lcurly command rcurly) (list 'function $3 $6))]
           
           [CALL ((VAR lpar ARGS rpar) (list 'call-func $1 $3))]
           
           [assign
            ((VAR seteq exp) (list 'seteq $1 $3))
            ((VAR seteq FUNCTION) (list 'setqfunc $1 $3))
            ((VAR seteq CALL) (list 'setqcall $1 $3))
            ]
           ...
           [bexp
            ...
            [VARS
             ((VAR) (list 'funcvar $1))
             ((VAR comma VARS) (list 'funcvars $1 $3))
             ]
...
;(define my-lexer (lex-this simple-lexer (open-input-string "a = 3; b = [2, 3, 4]; return a + b")))
